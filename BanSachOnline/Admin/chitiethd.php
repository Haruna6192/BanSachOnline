              ...
              <div class="box box-info">
                ...
                <form class="form-horizontal" >
                  ...
                  <div class="box-footer">
                    ...
                    <a href="update-order.php?sodh=<?= $row['sodh'] ?>&col=trangthai&value=Đã thanh toán"><button type="button" name="cancel" class="btn btn-success">Đã thanh toán</button></a>
                    <a href="update-order.php?sodh=<?= $row['sodh'] ?>&col=trangthai&value=Chưa thanh toán"><button type="button" name="cancel" class="btn btn-danger">Chưa thanh toán</button></a>
                    <a href="update-order.php?sodh=<?= $row['sodh'] ?>&col=tientrinh&value=Đã giao hàng"><button type="button" name="cancel" class="btn btn-success">Đã giao hàng</button></a>
                    <!-- /* -------------------------- THAO TÁC VỚI ĐƠN HÀNG ------------------------- */ -->
