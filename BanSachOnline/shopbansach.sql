...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 25, 2024 lúc 10:44 AM
...
(159, 136, 219, 1, 59, 59.00, ''),
(160, 137, 216, 1, 110, 110.00, '16'),
(161, 137, 218, 0, 200, 0.00, '16');
...
INSERT INTO `hoadon` (`sodh`, `emailkh`, `ngaygiao`, `tenkh`, `diachi`, `dienthoai`, `hinhthucthanhtoan`, `thanhtien`, `trangthai`, `tientrinh`) VALUES
(136, 'nghiadaica@gmail.com', '2024-03-25', 'Nghĩa Đại Ca', 'đà nẵng', '0366461704', 'ATM', 0.00, '', ''),
(137, 'nghiadaica@gmail.com', '2024-03-25', 'Nghĩa Đại Ca', 'đà nẵng', '0366461704', 'ATM', 330.00, 'Đã thanh toán', 'Đã giao hàng');
...
('nghiadaica@gmail.com', 'vv', 'gfhjgkj', '0366461704000000'),
('user@gmail.com', 'vv', 'Người dùng', '0333444555');
...
--
ALTER TABLE `chitiethoadon`
  MODIFY `id_chi_tiet_hoadon` bigint(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;
...
--
ALTER TABLE `hoadon`
  MODIFY `sodh` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;
